...
The Maps SDK’s own components, drawn over the map. Each is a real web
component that finds the map itself.
[`add_widget()`](http://r.esri.com/arcgisviz/reference/add_widget.md) is
the mechanism the rest are sugar for, and reaches components without a
wrapper.

- [`add_legend()`](http://r.esri.com/arcgisviz/reference/add_legend.md)
  : Add a legend
- [`add_layer_list()`](http://r.esri.com/arcgisviz/reference/add_layer_list.md)
  : Add a layer list
- [`add_basemap_gallery()`](http://r.esri.com/arcgisviz/reference/add_basemap_gallery.md)
  [`add_basemap_toggle()`](http://r.esri.com/arcgisviz/reference/add_basemap_gallery.md)
  : Add a basemap gallery
- [`add_search()`](http://r.esri.com/arcgisviz/reference/add_search.md)
  : Add a search box
- [`add_bookmarks()`](http://r.esri.com/arcgisviz/reference/add_bookmarks.md)
  : Add a bookmark list
- [`add_scale_bar()`](http://r.esri.com/arcgisviz/reference/add_scale_bar.md)
  : Add a scale bar
- [`add_coordinate_conversion()`](http://r.esri.com/arcgisviz/reference/add_coordinate_conversion.md)
  : Add a coordinate readout
- [`add_zoom()`](http://r.esri.com/arcgisviz/reference/add_zoom.md)
  [`add_home()`](http://r.esri.com/arcgisviz/reference/add_zoom.md)
  [`add_compass()`](http://r.esri.com/arcgisviz/reference/add_zoom.md)
  [`add_fullscreen()`](http://r.esri.com/arcgisviz/reference/add_zoom.md)
  [`add_locate()`](http://r.esri.com/arcgisviz/reference/add_zoom.md)
  [`add_track()`](http://r.esri.com/arcgisviz/reference/add_zoom.md) :
  Add a navigation control
- [`add_sketch()`](http://r.esri.com/arcgisviz/reference/add_sketch.md)
  : Add a drawing tool
- [`add_editor()`](http://r.esri.com/arcgisviz/reference/add_editor.md)
  : Add an editor
- [`add_measurement()`](http://r.esri.com/arcgisviz/reference/add_measurement.md)
  : Add a measurement tool
- [`add_widget()`](http://r.esri.com/arcgisviz/reference/add_widget.md)
  [`remove_widget()`](http://r.esri.com/arcgisviz/reference/add_widget.md)
  : Add a widget to a map
- [`map_widgets()`](http://r.esri.com/arcgisviz/reference/map_widgets.md)
  : Every widget a map can carry
- [`MapWidget`](http://r.esri.com/arcgisviz/reference/MapWidget.md) : A
  widget on a map
...
Update a chart or map that is already on screen without resending its
data, and read back what the reader did to it.
...
- [`ILegendOptionsOrder()`](http://r.esri.com/arcgisviz/reference/ILegendOptionsOrder.md)
  : ILegendOptionsOrder
