"use strict";(self.webpackChunk=self.webpackChunk||[]).push([[59438],{12668(e,t,a){a.d(t,{b:()=>B});var o=a(29785),i=a(77788),r=a(24615),n=a(31790),l=a(37716),s=a(32728),c=a(44418),d=a(3525),u=a(79887),h=a(51229),m=a(73713),p=a(83143),f=a(11255),v=a(36261),g=a(50710),x=a(87646),b=a(79344),w=a(40574),y=a(23605),M=a(75762),S=a(35212),C=a(65275),T=a(69563),I=a(24578),_=a(73349),D=a(79377),z=a(21586),F=a(64802),H=a(92121),P=a(19635),j=a(62462),W=a(19778),O=a(57777),R=a(73395),N=a(82315),E=a(43398),G=a(76221);function B(e){const t=new E.N5,{attributes:a,vertex:B,fragment:L,varyings:V}=t,{output:A,normalType:U,offsetBackfaces:k,spherical:q,snowCover:$,pbrMode:Z,textureAlphaPremultiplied:Y,instancedDoublePrecision:J,hasVertexColors:K,hasVertexTangents:X,hasColorTexture:Q,hasNormalTexture:ee,hasNormalTextureTransform:te,hasColorTextureTransform:ae}=e;if((0,z.NB)(B,e),a.add("position","vec3"),B.inputs.add("position",()=>"position"),V.add("vpos","vec3",{invariant:!0}),t.include(I.A,e),t.include(s.B,e),t.include(f.Ge,e),t.include(T.q2,e),!(0,i._o)(A))return t.include(v.E,e),t;t.include(T.Sx,e),t.include(T.MU,e),t.include(T.O1,e),t.include(T.QM,e),(0,z.yu)(B,e),t.include(d.Y,e),t.include(n.d);const oe=0===U||1===U;return oe&&k&&t.include(o.M),t.include(g.J,e),t.include(p.Mh,e),t.include(l.v,e),V.add("vPositionLocal","vec3"),t.include(h.U,e),t.include(u.K,e),t.include(m.c,e),B.uniforms.add(new H.E("externalColor",e=>e.externalColor,{supportsNaN:!0})),V.add("vcolorExt","vec4"),B.include(c.WD),B.include(c.oF),t.include(J?C.QH:C.LA,e),B.main.add(j.H`
    forwardVertexColor();
    ...
    if (opacityMixMode != ${j.H.int(R.Um.ignore)} && vcolorExt.a < ${j.H.float(G.Q)}) {
      gl_Position = vec4(1e38, 1e38, 1e38, 1.0);
    }
    forwardLinearDepthToReadShadowMap();
  `),L.include(b.kA,e),L.include(x.n,e),t.include(_.S,e),L.include(r.HQ,e),t.include(N.D,e),(0,z.yu)(L,e),L.uniforms.add(B.uniforms.get("localOrigin"),new F.t("ambient",e=>e.ambient),new F.t("diffuse",e=>e.diffuse),new P.m("opacity",e=>e.opacity),new P.m("layerOpacity",e=>e.layerOpacity)),Q&&L.uniforms.add(new W.N("tex",e=>e.texture)),t.include(S._,e),L.include(M.c,e),L.include(D.N),t.include(y.r,e),L.include(O.b,e),(0,b.a8)(L),(0,b.eU)(L),(0,w.O4)(L),L.main.add(j.H`
    discardBySlice(vpos);
    ${Q?j.H`
  ...
  `),t}const L=Object.freeze(Object.defineProperty({__proto__:null,build:B},Symbol.toStringTag,{value:"Module"}));a.d(t,["D",0,L])},22950(e,t,a){a.d(t,{G:()=>g,c:()=>x});var o=a(50400),i=a(11422),r=a(56926),n=a(40574),l=a(10452),s=a(36288),c=a(19635),d=a(62462),u=a(7574),h=a(96384),m=a(19778),p=a(60577),f=(a(68716),a(13439)),v=a(43398);class g extends f.Y{constructor(){super(...arguments),this.projScale=1,this.scaleGlobalIllumination=1,this.accumulatedFrames=0,this.temporalSampleFrame=0,this.rayMarchMinReach=.15,this.rayMarchMaxReach=.5,this.rayMarchWorldReach=25,this.rayMarchMinReachEmissionWeight=1,this.rayMarchMaxReachEmissionWeight=1,this.rayMarchMaxSteps=16,this.colorBleedWeight=.15}}function x(e){const t=new v.N5,a=t.fragment;return t.include(o.c),t.include(s.Ir),(0,n.Gc)(a),a.include(i.V),a.include(r.C),a.include(p.R),t.include(l.O,e),a.uniforms.add(new m.N("normalMap",e=>e.normalTexture),new m.N("depthMap",e=>e.depthTexture),new h.x("lastFrameColorTexture",e=>e.reprojection.lastFrameColor?.getTexture()),new h.x("lastFrameDepthTexture",e=>e.reprojection.lastFrameDepth?.attachment),new h.x("lastFrameGlobalIlluminationTexture",e=>e.globalIllumination?.getTexture()),new h.x("lastFrameGlobalIlluminationWeightTexture",e=>e.globalIllumination?.getTexture(36065)),new u.F("reprojectionViewMatrix",e=>e.reprojection.viewMatrix),new u.F("view",e=>e.camera.viewMatrix),new c.m("accumulatedFrames",e=>e.accumulatedFrames),new c.m("temporalSampleFrame",e=>e.temporalSampleFrame),new c.m("scaleGlobalIllumination",e=>e.scaleGlobalIllumination)),a.uniforms.add(new c.m("rayMarchMinReach",e=>e.rayMarchMinReach),new c.m("rayMarchMaxReach",e=>e.rayMarchMaxReach),new c.m("rayMarchWorldReach",e=>e.rayMarchWorldReach),new c.m("rayMarchMinReachEmissionWeight",e=>e.rayMarchMinReachEmissionWeight),new c.m("rayMarchMaxReachEmissionWeight",e=>e.rayMarchMaxReachEmissionWeight),new c.m("rayMarchMaxSteps",e=>e.rayMarchMaxSteps),new c.m("colorBleedWeight",e=>e.colorBleedWeight)),e.hasEmission&&a.uniforms.add(new h.x("lastFrameEmissionTexture",e=>e.reprojection.lastFrameEmission?.attachment)),a.code.add(d.H`
  ...
  `),t}const b=Object.freeze(Object.defineProperty({__proto__:null,GlobalIlluminationPassParameters:g,build:x,defaultColorBleedWeight:.15,defaultRayMarchMaxReach:.5,defaultRayMarchMaxReachEmissionWeight:1,defaultRayMarchMaxSteps:16,defaultRayMarchMinReach:.15,defaultRayMarchMinReachEmissionWeight:1,defaultRayMarchWorldReach:25},Symbol.toStringTag,{value:"Module"}));a.d(t,["a",0,b])},37809(e,t,a){a.d(t,{G:()=>b,b:()=>w});var o=a(56560),i=a(50400),r=a(16937),n=a(49874),l=a(36288),s=a(70483),c=a(37138),d=a(19635),u=a(62462),h=a(29247),m=a(19778),p=a(60577),f=a(71038),v=a(41414),g=a(13439),x=a(43398);class b extends g.Y{constructor(){super(...arguments),this.blurSize=(0,o.vt)()}}function w(){const e=new x.N5,t=e.fragment;e.include(i.c),e.include(l.Ir),e.include(n.Q);return t.include(r.E),t.include(f.t,y),t.include(p.R),t.uniforms.add(new s.o("hasEmission",e=>e.hasEmission),new m.N("depthMap",e=>e.depthTexture),new m.N("normalMap",e=>e.normalTexture),new h.o("globalIlluminationTexture",e=>e.texture),new h.o("globalIlluminationWeightTexture",e=>e.weightTexture),new c.t("blurSize",e=>e.blurSize),new d.m("scaleGlobalIllumination",e=>e.scaleGlobalIllumination),new d.m("projScale",(e,t)=>{const a=t.camera.distance;return a>5e4?Math.max(0,e.projScale-(a-5e4)):e.projScale})),t.code.add(u.H`
...
fragColor.rgb = quantizeGlobalIlluminationColor(fragColor.rgb);`),e}const v=Object.freeze(Object.defineProperty({__proto__:null,GlobalIlluminationUpscaleDrawParameters:p,build:f},Symbol.toStringTag,{value:"Module"}));a.d(t,["a",0,v])},38716(e,t,a){a.d(t,{b:()=>N});var o=a(29785),i=a(77788),r=a(24615),n=a(31790),l=a(37716),s=a(32728),c=a(44418),d=a(3525),u=a(79887),h=a(51229),m=a(73713),p=a(11255),f=a(36261),v=a(87646),g=a(79344),x=a(40574),b=a(75762),w=a(35212),y=a(65275),M=a(69563),S=a(24578),C=a(73349),T=a(79377),I=a(21586),_=a(64802),D=a(92121),z=a(19635),F=a(62462),H=a(19778),P=a(57777),j=a(73395),W=a(92703),O=a(82315),R=a(43398);function N(e){const t=new R.N5,{attributes:a,vertex:N,fragment:E,varyings:G}=t,{output:B,offsetBackfaces:L,pbrMode:V,snowCover:A,spherical:U}=e,k=1===V||2===V;if((0,I.NB)(N,e),a.add("position","vec3"),N.inputs.add("position",()=>"position"),G.add("vpos","vec3",{invariant:!0}),t.include(S.A,e),t.include(s.B,e),t.include(p.Ge,e),t.include(M.q2,e),!(0,i._o)(B))return t.include(f.E,e),t;t.include(M.MU,e),(0,I.yu)(t.vertex,e),t.include(d.Y,e),t.include(n.d),L&&t.include(o.M),G.add("vNormalWorld","vec3"),G.add("localvpos","vec3",{invariant:!0}),t.include(h.U,e),t.include(u.K,e),t.include(l.v,e),t.include(m.c,e),N.include(c.WD),N.include(c.oF),N.uniforms.add(new D.E("externalColor",e=>e.externalColor,{supportsNaN:!0})),G.add("vcolorExt","vec4"),t.include(e.instancedDoublePrecision?y.QH:y.LA,e),N.include(W.Q),N.main.add(F.H`
    forwardVertexColor();
  ...
  `);const{hasColorTexture:q,hasColorTextureTransform:$}=e;return E.include(g.kA,e),E.include(v.n,e),t.include(C.S,e),E.include(r.HQ,e),t.include(O.D,e),(0,I.yu)(E,e),(0,x.Gc)(E),(0,g.a8)(E),(0,g.eU)(E),E.uniforms.add(N.uniforms.get("localOrigin"),N.uniforms.get("view"),new _.t("ambient",e=>e.ambient),new _.t("diffuse",e=>e.diffuse),new z.m("opacity",e=>e.opacity),new z.m("layerOpacity",e=>e.layerOpacity)),q&&E.uniforms.add(new H.N("tex",e=>e.texture)),t.include(w._,e),E.include(b.c,e),E.include(T.N),E.include(P.b,e),(0,x.O4)(E),E.main.add(F.H`
      discardBySlice(vpos);
      ...
      vec4 finalColor = vec4(shadedColor, opacity_);
      outputColorHighlightOLID(applySlice(finalColor, vpos), albedo ${(0,F.If)(A,", 1.0")});`),t}const E=Object.freeze(Object.defineProperty({__proto__:null,build:N},Symbol.toStringTag,{value:"Module"}));a.d(t,["R",0,E])},43300(e,t,a){a.d(t,{b:()=>v,g:()=>g});var o=a(53334),i=a(56560),r=a(50400),n=a(16937),l=a(56926),s=a(36288),c=a(33),d=a(66579),u=a(41281),h=a(19635),m=a(62462),p=a(19778),f=a(43398);function v(){const e=new f.N5,t=e.fragment;return e.include(r.c),e.include(s.Ir),t.include(n.E),t.include(l.C),t.uniforms.add(new u.U("radius",e=>g(e.camera))).code.add(m.H`vec3 sphere[16] = vec3[16](
...
return fallOffFunction(vv, vn, 0.1);
    ...
    fragOcclusion = A;
  `),e}function g(e){return Math.max(10,20*e.computeScreenPixelSizeAtDist(Math.abs(4*e.relativeElevation)))}const x=(0,i.vt)(),b=Object.freeze(Object.defineProperty({__proto__:null,build:v,getRadius:g},Symbol.toStringTag,{value:"Module"}));a.d(t,["S",0,b])},26599(e,t,a){a.d(t,{b:()=>u});var o=a(50400),i=a(16937),r=a(37138),n=a(19635),l=a(62462),s=a(29247),c=a(19778),d=a(43398);function u(){const e=new d.N5,t=e.fragment;return e.include(o.c),t.include(i.E),t.uniforms.add(new c.N("depthMap",e=>e.depthTexture),new s.o("tex",e=>e.colorTexture),new r.t("blurSize",e=>e.blurSize),new n.m("projScale",(e,t)=>{const a=t.camera.distance;return a>5e4?Math.max(0,e.projScale-(a-5e4)):e.projScale})),t.code.add(l.H`
...
}`);break;case 2:e.vertex.code.add(l.H`void forwardNormal() {}`);break;default:t.normalType;case 3:}}class d extends n.dO{constructor(){super(...arguments),this.transformNormalViewFromGlobal=(0,o.vt)()}}class u extends n.EM{constructor(){super(...arguments),this.toMapSpace=(0,i.vt)()}}},36261(e,t,a){a.d(t,{E:()=>g});var o=a(14225),i=a(24615),r=a(31790),n=a(3525),l=a(38587),s=a(51229),c=a(83143),d=a(23932),u=a(20524),h=a(24578),m=a(73349),p=a(21586),f=a(62462),v=a(19778);function g(e,t){const{vertex:a,fragment:g,varyings:x}=e,{hasColorTexture:b,alphaDiscardMode:w}=t,y=b&&1!==w,{output:M,normalType:S,hasColorTextureTransform:C}=t;switch(M){case 3:(0,p.NB)(a,t),e.include(r.d),g.include(i.HQ,t),e.include(s.U,t),y&&g.uniforms.add(new v.N("tex",e=>e.texture)),a.main.add(f.H`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),e.include(m.S,t),g.main.add(f.H`
        discardBySlice(vpos);
        ${(0,f.If)(y,f.H`vec4 texColor = texture(tex, ${C?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 5:case 6:case 7:case 8:case 11:(0,p.NB)(a,t),e.include(r.d),e.include(s.U,t),e.include(h.A,t),e.include(d.L,t),g.include(i.HQ,t),e.include(l.g,t),(0,o.xJ)(e),x.add("depth","float",{invariant:!0}),y&&g.uniforms.add(new v.N("tex",e=>e.texture)),a.main.add(f.H`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),e.include(m.S,t),g.main.add(f.H`
        ...
        ${(0,f.If)(y,f.H`vec4 texColor = texture(tex, ${C?"colorUV":"vuv0"});
               discardOrAdjustAlpha(texColor);`)}
        ${11===M?f.H`outputObjectAndLayerIdColor();`:f.H`outputDepth(depth);`}`);break;case 4:{(0,p.NB)(a,t),e.include(r.d),e.include(n.Y,t),e.include(c.Mh,t),e.include(s.U,t),e.include(h.A,t),y&&g.uniforms.add(new v.N("tex",e=>e.texture)),2===S&&x.add("vPositionView","vec3",{invariant:!0});const o=0===S||1===S;a.main.add(f.H`
        vpos = getVertexInLocalOriginSpace();
        ...
        fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case 10:(0,p.NB)(a,t),e.include(r.d),e.include(s.U,t),e.include(h.A,t),y&&g.uniforms.add(new v.N("tex",e=>e.texture)),a.main.add(f.H`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
}`)}},87646(e,t,a){a.d(t,{n:()=>H});var o=a(62462),i=a(96384),r=a(31635),n=a(4506),l=a(57725),s=a(61985),c=a(67900),d=a(69636),u=a(53334),h=a(6744),m=a(84586),p=a(43300),f=a(70051),v=a(73218),g=a(26599),x=a(15651);let b=class extends v.w{constructor(){super(...arguments),this.shader=new f.r(g.S,()=>a.e(87920).then(a.bind(a,87920)))}initializePipeline(){return(0,x.Ey)({colorWrite:x.kn})}};b=(0,r.Cg)([(0,d.$K)("esri.views.3d.webgl-engine.effects.ssao.SSAOBlurTechnique")],b);var w=a(56560),y=a(13439);class M extends y.Y{constructor(){super(...arguments),this.projScale=1}}class S extends M{constructor(){super(...arguments),this.intensity=1}}class C extends y.Y{}class T extends C{constructor(){super(...arguments),this.blurSize=(0,w.vt)()}}let I=class extends v.w{constructor(){super(...arguments),this.shader=new f.r(p.S,()=>a.e(87447).then(a.bind(a,87447)))}initializePipeline(){return(0,x.Ey)({colorWrite:x.kn})}};I=(0,r.Cg)([(0,d.$K)("esri.views.3d.webgl-engine.effects.ssao.SSAOTechnique")],I),a(68716);var _=a(22497),D=a(88416);let z=class extends m.A{constructor(e){super(e),this.consumes={required:["normals"]},this.produces=h.OG.AMBIENT_ILLUMINATION,this._enableTime=(0,c.l5)(0),this._passParameters=new S,this._drawParameters=new T}initialize(){const e=Uint8Array.from(atob(""),e=>e.charCodeAt(0)),t=new D.R(32);t.wrapMode=33071,t.pixelFormat=6407,t.wrapMode=10497,t.hasMipmap=!0,this._passParameters.noiseTexture=new _.A(this.renderingContext,t,e),this.addHandles((0,s.wB)(()=>this.view.stage.renderer.hasAmbientIllumination,()=>this._enableTime=(0,c.l5)(0)))}destroy(){this._passParameters.noiseTexture=(0,l.WD)(this._passParameters.noiseTexture)}render(e){const t=e.find(({name:e})=>"normals"===e),a=t?.getTexture(),o=t?.getTexture(33306);if(!a||!o)return;const i=this.techniques.getCompiled(I),r=this.techniques.getCompiled(b);if(!i||!r)return this._enableTime=(0,c.l5)(performance.now()),void this.requestRender(1);0===this._enableTime&&(this._enableTime=(0,c.l5)(performance.now()));const l=this.renderingContext,s=this.view.qualitySettings.fadeDuration,d=this.bindParameters,m=d.camera,f=m.relativeElevation,v=(0,n.qE)((5e5-f)/2e5,0,1),g=s>0?Math.min(s,performance.now()-this._enableTime)/s:1,x=g*v;this._passParameters.normalTexture=a,this._passParameters.depthTexture=o,this._passParameters.projScale=1/m.computeScreenPixelSizeAtDist(1),this._passParameters.intensity=4*F/(0,p.g)(m)**6*x;const w=m.fullViewport[2],y=m.fullViewport[3],M=this.fboCache.acquire(w,y,"ssao input",2);l.bindFramebuffer(M.fbo),l.setViewport(0,0,w,y),l.bindTechnique(i,d,this._passParameters,this._drawParameters),l.screen.draw();const S=Math.round(w/2),C=Math.round(y/2),T=this.fboCache.acquire(S,C,"ssao blur",0);l.bindFramebuffer(T.fbo),this._drawParameters.colorTexture=M.getTexture(),(0,u.hZ)(this._drawParameters.blurSize,0,2/y),l.bindTechnique(r,d,this._passParameters,this._drawParameters),l.setViewport(0,0,S,C),l.screen.draw(),M.release();const _=this.fboCache.acquire(S,C,h.OG.AMBIENT_ILLUMINATION,0);return l.bindFramebuffer(_.fbo),l.setViewport(0,0,w,y),l.setClearColor(1,1,1,0),l.clear(16384),this._drawParameters.colorTexture=T.getTexture(),(0,u.hZ)(this._drawParameters.blurSize,2/w,0),l.bindTechnique(r,d,this._passParameters,this._drawParameters),l.setViewport(0,0,S,C),l.screen.draw(),l.setViewport4fv(m.fullViewport),T.release(),g<1&&this.requestRender(2),_}};(0,r.Cg)([(0,d.MZ)()],z.prototype,"consumes",void 0),(0,r.Cg)([(0,d.MZ)()],z.prototype,"produces",void 0),z=(0,r.Cg)([(0,d.$K)("esri.views.3d.webgl-engine.effects.ssao.SSAO")],z);const F=.5;function H(e,t){t.receiveAmbientOcclusion?(e.uniforms.add(new i.x("ssaoTex",e=>e.ssao?.getTexture())),e.constants.add("blurSizePixelsInverse","float",.5),e.code.add(o.H`float evaluateAmbientOcclusionInverse() {
...
float evaluateAmbientOcclusion() { return 0.0; }`)}},79344(e,t,a){a.d(t,{kA:()=>N,a8:()=>O,eU:()=>R});var o=a(71158),i=a(87646),r=a(56926),n=a(40574),l=a(75762),s=a(48425),c=a(70483),d=a(62462),u=a(96384),h=a(31635),m=a(57725),p=a(61985),f=a(69636),v=a(53334),g=a(6744),x=a(84586),b=a(22950),w=a(37809),y=a(70051),M=a(73218),S=a(15651);let C=class extends M.w{constructor(){super(...arguments),this.shader=new y.r(w.a,()=>a.e(83044).then(a.bind(a,83044)))}initializePipeline(){return(0,S.Ey)({colorWrite:S.kn})}};C=(0,h.Cg)([(0,f.$K)("esri.views.3d.webgl-engine.effects.globalIllumination.GlobalIlluminationBlurTechnique")],C);let T=class extends M.w{constructor(){super(...arguments),this.shader=new y.r(b.a,()=>a.e(54699).then(a.bind(a,54699)))}initializePipeline(){return(0,S.Ey)({colorWrite:S.kn})}};T=(0,h.Cg)([(0,f.$K)("esri.views.3d.webgl-engine.effects.globalIllumination.GlobalIlluminationTechnique")],T);var I=a(67069);class _ extends I.K{constructor(){super(...arguments),this.hasColor=!0,this.hasEmission=!1,this.rayMarchMaxReach=.5,this.rayMarchMaxSteps=16,this.useProjectedRayLength=!0,this.clampRayToScreen=!1}}(0,h.Cg)([(0,I.W)()],_.prototype,"hasColor",void 0),(0,h.Cg)([(0,I.W)()],_.prototype,"hasEmission",void 0);var D=a(27351);let z=class extends M.w{constructor(){super(...arguments),this.shader=new y.r(D.a,()=>a.e(47824).then(a.bind(a,47824)))}initializePipeline(){return(0,S.Ey)({colorWrite:S.kn})}};z=(0,h.Cg)([(0,f.$K)("esri.views.3d.webgl-engine.effects.globalIllumination.GlobalIlluminationUpscaleTechnique")],z),a(68716);let F=class extends x.A{constructor(e){super(e),this.consumes={required:["normals"]},this.produces=g.OG.AMBIENT_ILLUMINATION,this._passParameters=new b.G,this._drawParameters=new w.G,this._drawParametersUpscale=new D.G,this._maxFrames=256,this._lowQualityResolutionScale=.25,this._configuration=new _,this._globalIllumination=null,this._isGlobalIlluminationUpdate=!1,this._resetBuffer=!1}initialize(){this.addHandles((0,p.wB)(()=>this.view.stage.renderer.hasGlobalIllumination,()=>{this._resetAccumulatedFrames(),this._requestRender()},p.pc))}destroy(){this._globalIllumination=(0,m.Gz)(this._globalIllumination)}resetAccumulatedFrames(){this._isGlobalIlluminationUpdate||this._resetAccumulatedFrames()}render(e){if(this._passParameters.accumulatedFrames>=this._maxFrames)return this._globalIllumination?.retain(),this._globalIllumination;const t=e.find(({name:e})=>"normals"===e),a=t?.getTexture(),o=t?.getTexture(33306),i=this._mode;if(!a||!o)return this._emptyOutput;if(0===i)return this._resetBuffer=!1,this._emptyOutput;if(!this._canRender)return this._resetBuffer=!1,this._requestRender(),this._emptyOutput;const r=this.bindParameters;this._configuration.hasEmission=!!r.reprojection.lastFrameEmission;const n=this.techniques.getCompiled(T,this._configuration),l=this.techniques.getCompiled(C),s=1===i,c=s?this._lowQualityResolutionScale:1,d=s?this.techniques.getCompiled(z):null;if(!n||!l||s&&!d)return this._requestRender(),this._emptyOutput;const u=this.renderingContext,{camera:h}=r;this._passParameters.normalTexture=a,this._passParameters.depthTexture=o,this._passParameters.projScale=1/h.computeScreenPixelSizeAtDist(1),this._passParameters.scaleGlobalIllumination=c;const{fullWidth:m,fullHeight:p}=h,f=Math.max(1,Math.floor(m*c)),x=Math.max(1,Math.floor(p*c)),b=this.fboCache.acquire(f,x,"global illumination input").acquireColor(36065,0);u.bindFramebuffer(b.fbo),u.setViewport(0,0,f,x),u.bindTechnique(n,r,this._passParameters,this._drawParameters),u.screen.draw();const w=b.obtainAttachment(36065),y=Math.max(1,Math.round(f/1)),M=Math.max(1,Math.round(x/1)),S=this.fboCache.acquire(y,M,"global illumination blur horizontal");u.bindFramebuffer(S.fbo),this._drawParameters.texture=b.getTexture(),this._drawParameters.weightTexture=w.attachment,(0,v.hZ)(this._drawParameters.blurSize,0,1/x),u.bindTechnique(l,r,this._passParameters,this._drawParameters),u.setViewport(0,0,y,M),u.screen.draw(),b.release();const I=s?"global illumination blur vertical":g.OG.AMBIENT_ILLUMINATION,_=this.fboCache.acquire(y,M,I);u.bindFramebuffer(_.fbo),u.setViewport(0,0,y,M),u.setClearColor(1,1,1,0),u.clear(16384),this._drawParameters.texture=S.getTexture(),this._drawParameters.weightTexture=w.attachment,(0,v.hZ)(this._drawParameters.blurSize,1/y,0),u.bindTechnique(l,r,this._passParameters,this._drawParameters),u.setViewport(0,0,y,M),u.screen.draw(),S.release(),_.attachColor(w,36065),w.release();let D=_;return d&&(D=this.fboCache.acquire(m,p,g.OG.AMBIENT_ILLUMINATION).acquireColor(36065,0),u.bindFramebuffer(D.fbo),u.setViewport(0,0,m,p),u.setClearColor(1,1,1,0),u.clear(16384),this._drawParametersUpscale.colorTexture=_.getTexture(),this._drawParametersUpscale.weightTexture=_.getTexture(36065),u.bindTechnique(d,r,this._passParameters,this._drawParametersUpscale),u.screen.draw(),_.release()),u.setViewport4fv(h.fullViewport),this._passParameters.temporalSampleFrame=(this._passParameters.temporalSampleFrame+1)%64,++this._passParameters.accumulatedFrames,this._cacheGlobalIllumination(D),this._passParameters.accumulatedFrames<this._maxFrames&&this._requestRender(),D}_requestRender(){this._isGlobalIlluminationUpdate=!0,this.requestRender(1),this._isGlobalIlluminationUpdate=!1}_cacheGlobalIllumination(e){this._globalIllumination!==e&&(this._globalIllumination=(0,m.Gz)(this._globalIllumination),this._globalIllumination=e,this._globalIllumination.retain())}get _emptyOutput(){const e=this.renderingContext,{fullWidth:t,fullHeight:a}=this.bindParameters.camera,o=this.fboCache.acquire(t,a,g.OG.AMBIENT_ILLUMINATION).acquireColor(36065,0);return e.bindFramebuffer(o.fbo),e.setViewport(0,0,t,a),e.clearBuffer(0,[0,0,0,1]),e.clearBuffer(1,[0,0,0,0]),o}get _canRender(){const{reprojection:e,hasEmission:t,globalIllumination:a}=this.bindParameters;return!(!e.lastFrameColor||t&&!e.lastFrameEmission||!e.lastFrameDepth||!a||this._resetBuffer)}get _mode(){const{hasGlobalIlluminationHighQuality:e,hasGlobalIllumination:t}=this.view.stage.renderer;return e?2:t?1:0}_resetAccumulatedFrames(){this._passParameters.accumulatedFrames=0,this._globalIllumination=(0,m.Gz)(this._globalIllumination)}get test(){const e=this;return{passParameters:this._passParameters,configuration:this._configuration,get maxFrames(){return e._maxFrames},set maxFrames(t){e._maxFrames=t},get lowQualityResolutionScale(){return e._lowQualityResolutionScale},set lowQualityResolutionScale(t){e._lowQualityResolutionScale=t},get mode(){return e._mode},restartAccumulation:()=>{this._resetAccumulatedFrames(),this._passParameters.temporalSampleFrame=0,this._resetBuffer=!0,this._requestRender()}}}};function H(e,t){t.receiveGlobalIllumination?(e.uniforms.add(new c.o("hasGlobalIlluminationTexture",e=>null!=e.globalIllumination),new u.x("globalIlluminationTexture",e=>e.globalIllumination?.getTexture())),e.constants.add("blurSizePixelsInverse","float",1),e.code.add(d.H`vec3 readGlobalIlluminationOcclusionInverse() {
...
vec4 readGlobalIlluminationEmission() { return vec4(0.0); }`)}(0,h.Cg)([(0,f.MZ)()],F.prototype,"consumes",void 0),(0,h.Cg)([(0,f.MZ)()],F.prototype,"produces",void 0),F=(0,h.Cg)([(0,f.$K)("esri.views.3d.webgl-engine.effects.globalIllumination.GlobalIllumination")],F);var P=a(41281);function j(e){e.code.add(d.H`float mapChannel(float x, vec2 p) {
...
}`)}a(4477);var W=a(16782);function O(e){e.constants.add("ambientBoostFactor","float",.4)}function R(e){e.uniforms.add(new P.U("lightingGlobalFactor",e=>e.lighting.globalFactor))}function N(e,t){const{pbrMode:a,spherical:u,hasColorTexture:h,receiveGlobalIllumination:m}=t;e.include(r.C),e.include(H,t),e.include(i.n,t),0!==a&&e.include(l.c,t),e.include(o.W,t),e.include(s.p),e.include(W.b,t);const p=!(2===a&&!h);p&&e.include(j),O(e),R(e),(0,n.Gc)(e),e.code.add(d.H`
...
return delinearizeGamma(outColor);
      ...
      `),e.uniforms.add(new P.U("lightingSpecularStrength",e=>e.lighting.mainLight.specularStrength),new P.U("lightingEnvironmentStrength",e=>e.lighting.mainLight.environmentStrength)).code.add(d.H`
...
float occlusion;`),d&&c.uniforms.add(1===p?new s.N("texMetallicRoughness",e=>e.textureMetallicRoughness):new l.o("texMetallicRoughness",e=>e.textureMetallicRoughness)),h&&c.uniforms.add(1===p?new s.N("texOcclusion",e=>e.textureOcclusion):new l.o("texOcclusion",e=>e.textureOcclusion)),c.uniforms.add(1===p?new r.t("mrrFactors",e=>e.mrrFactors):new i.W("mrrFactors",e=>e.mrrFactors)),c.code.add(n.H`
  ...
  `)}(a(40327),a(13439)).Y},65275(e,t,a){a.d(t,{LA:()=>M,QH:()=>y}),a(19913);var o=a(47635),i=a(77788),r=a(62462);function n(e,t){const a=(0,i._o)(t.output)&&t.receiveShadows;a&&(0,o.o)(e,!0),e.vertex.code.add(r.H`
